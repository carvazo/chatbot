...
var fQnAMaker = function(session, iQuestion){
    // definitions
    var lQnaMakerServiceEndpoint = 'https://westus.api.cognitive.microsoft.com/qnamaker/v1.0/knowledgebases/';
    var lQnaApi = 'generateanswer';
    var lKnowledgeBaseId = 'KnowledgeBaseId';
    var lSubscriptionKey = 'SubscriptionKey';
...
var bot = new builder.UniversalBot(connector, [
    ...
    function (session, results){
        ...
        // }
        else if(session.dialogData.select.type == '')
        {
...
function getCardAttachments(session){
    return [
        ...
        new builder.HeroCard(session)
            ...
            .buttons([ builder.CardAction.imBack(session,"2","2.자주 묻는 질문")]),
    ];
}
